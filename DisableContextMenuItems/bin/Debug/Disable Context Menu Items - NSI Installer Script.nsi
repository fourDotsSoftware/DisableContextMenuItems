...
;copy translations end
  ...
  !define MUI_FILE "DisableContextMenuItems"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Disable Context Menu Items"
  !define PRODUCT_SHORTCUT "Disable Context Menu Items"
  !define PRODUCT_VERSION "1.4"
  
  !define MUI_ICON "disable-context-menu-items-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Disable Context Menu Items"
  OutFile "DisableContextMenuItemsSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Disable Context Menu Items" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Disable Context Menu Items - User's Manual.url.lnk" "$INSTDIR\Disable Context Menu Items - User's Manual.url" "" "$INSTDIR\Disable Context Menu Items - User's Manual.url" 0
...
!endif
  ...
  !insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\DisableContextMenuItemsExt64.dll $SYSDIR\DisableContextMenuItemsExt.dll $SYSDIR
  SetRegView 64
...
${Else}
  ...
  !insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\DisableContextMenuItemsExt32.dll $SYSDIR\DisableContextMenuItemsExt.dll $SYSDIR
...
;Add files
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Disable Context Menu Items - User's Manual.url";
  File "ddb.dat"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Disable Context Menu Items" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Disable Context Menu Items" "InstallationDirectory" $INSTDIR
...
!endif
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\DisableContextMenuItemsExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Disable Context Menu Items"
  DeleteRegKey HKCU "Software\4dots Software\Disable Context Menu Items"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/disable-context-menu-items/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/disable-context-menu-items/how-to-use.php?afterinstall=true"
FunctionEnd
